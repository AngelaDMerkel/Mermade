...
export const MERMAID_HELP: Record<string, MermaidHelpContent> = {
  ...
  kanban: {
    purpose: "Visualize work items moving through a pull-based workflow.",
  ...
  eventmodeling: {
    ...
    resources: [mermaid("eventmodeling"), guide("Event Modeling method", "https://eventmodeling.org/posts/what-is-event-modeling/", "Method guide")],
  },
  railroad: {
  ...
  railroadEbnf: {
    purpose: "Visualize grammar productions written in Extended Backus–Naur Form.",
  ...
  railroadAbnf: {
    purpose: "Visualize protocol or language grammar written in Augmented Backus–Naur Form.",
  ...
  railroadPeg: {
    purpose: "Visualize parsing expression grammar rules with ordered choice and repetition.",
    ...
    pitfalls: ["Reordering PEG alternatives can change the recognized language."],
  ...
  quadrantChart: {
    purpose: "Position items against two independent dimensions to support comparison or prioritization.",
    ...
    resources: [mermaid("quadrantChart"), guide("Atlassian prioritization matrix guide", "https://www.atlassian.com/team-playbook/plays/prioritization-matrix", "Method guide")],
  },
  sankey: {
    purpose: "Show how quantities flow between stages, with link width proportional to magnitude.",
    tips: ["Use consistent units and preserve flow totals where the system is conservative.", "Order nodes to minimize crossings and make the dominant paths easy to follow."],
  ...
  radar: {
    purpose: "Compare several profiles across the same set of normalized dimensions.",
  ...
  treemap: {
    ...
    tips: ["Size every leaf with the same metric and use color for a separate, clearly explained variable.", "Keep hierarchy shallow and label the largest or most important areas directly."],
  ...
  ishikawa: {
    purpose: "Organize potential causes of a defined effect for root-cause exploration.",
    tips: ["Write one specific effect at the head and brainstorm cause categories with the people doing the work.", "Drill from symptoms toward controllable contributing causes and validate them with evidence."],
